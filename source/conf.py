...
html_theme_options = {
    ...
    'announcement': 'Geospatial Challenge Camp 2026 is looking for Partners and Participants', # to add urgent messages, Deadline extended! Sign up until the 20.09.2023
    'switcher': {
            'json_url': json_url,
